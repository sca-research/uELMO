#ifndef __UELMO_GADGET_H
#define __UELMO_GADGET_H

#include  <stdio.h>
#include <stdint.h>

extern void Isw_2(uint8_t * inputa, uint8_t * inputb, uint8_t * rnd, uint8_t * output);	// rnd_n = 1


extern void Isw_3(uint8_t * inputa, uint8_t * inputb, uint8_t * rnd, uint8_t * output);	// rnd_n = 3

unsigned char table[798] = {
    ...
    0x03, 0x05, 0x0f, 0x11, 0x33, 0x55, 0xff, 0x1a, 0x2e, 0x72, 0x96, 0xa1,
	0xf8, 0x13, 0x35,
    0x5f, 0xe1, 0x38, 0x48, 0xd8, 0x73, 0x95, 0xa4, 0xf7, 0x02, 0x06, 0x0a,
	0x1e, 0x22, 0x66, 0xaa,
    0xe5, 0x34, 0x5c, 0xe4, 0x37, 0x59, 0xeb, 0x26, 0x6a, 0xbe, 0xd9, 0x70,
