...
void mixColumns(uint8_t state[16])
{
    ...
    for (i = 0; i < 16; i += 4)
	{
	    ...
	    state[i + 1] =
		temp[0] ^ mul_02[temp[1]] ^ mul_03[temp[2]] ^ temp[3];
	    state[i + 2] =
		temp[0] ^ temp[1] ^ mul_02[temp[2]] ^ mul_03[temp[3]];
	    state[i + 3] =
		mul_03[temp[0]] ^ temp[1] ^ temp[2] ^ mul_02[temp[3]];
	}
}
