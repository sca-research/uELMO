    ...
    if ((!IsLDR) && core_current.Read_reg_update)       //LDR is still runing, while the new one is not LDR
        {
            ...
            update_component(&(core_current.D2E_reg1),
                             &(core_current.D2E_reg1_data));
            update_component(&(core_current.D2E_reg2),
                             &(core_current.D2E_reg2_data));
            return true;
        }
    //ADC two registers
    //Instr 8
    ...
    if ((inst & 0xF800) == 0x1000)
        {
            ...
            sprintf(core_current.Execute_instr_disp,
                    "Execute: asrs r%u,r%u,#0x%X", rd_ind, ra_ind,
                    rb.num_value);
    ...
    if ((inst & 0xF800) == 0x6800)
        {
            ...
            sprintf(core_current.Execute_instr_disp,
                    "Execute: ldr r%u,[r%u,#0x%X]", rd_ind, ra_ind,
                    rb.num_value);
    ...
    if ((inst & 0xF800) == 0x7800)
        {
            ...
            sprintf(core_current.Execute_instr_disp,
                    "Execute: ldrb r%u,[r%u,#0x%X]", rd_ind, ra_ind,
                    rb.num_value);
            core_current.Memory_read_targetreg = rd_ind;        //sent to memory
            update_component(&(core_current.Memory_addr), &rc);;
            core_current.Read_valid = true;
    ...
    if ((inst & 0xF800) == 0x8800)
        {
            ...
            sprintf(core_current.Execute_instr_disp,
                    "Execute: ldrh r%u,[r%u,#0x%X]", rd_ind, ra_ind,
                    rb.num_value);
    ...
    if ((inst & 0xF800) == 0x0000)
        {
            ...
            sprintf(core_current.Execute_instr_disp,
                    "Execute: lsls r%u,r%u,#0x%X", rd_ind, ra_ind,
                    rb.num_value);
            //Functional
            rc.num_value = ra.num_value;
            //TODO: update rc.exp
    ...
    if ((inst & 0xF800) == 0x0800)
        {
            ...
            sprintf(core_current.Execute_instr_disp,
                    "Execute: lsrs r%u,r%u,#0x%X", rd_ind, ra_ind,
                    rb.num_value);
            rc.num_value = ra.num_value;
            //TODO: update rc.exp
            //Functional
    ...
    if ((inst & 0xF800) == 0x6000)
        {
            ...
            sprintf(core_current.Execute_instr_disp,
                    "Execute: str r%u,[r%u,#0x%X]", rb_ind, ra_ind,
                    rc.num_value);
            //Functional
            rc.num_value <<= 2;
            //TODO: update rc.exp
    ...
    if ((inst & 0xF800) == 0x7000)
        {
            ...
            sprintf(core_current.Execute_instr_disp,
                    "Execute: strb r%u,[r%u,#0x%X]", rb_ind, ra_ind,
                    rc.num_value);
            //Functional
            rc.num_value = ra.num_value + rc.num_value;
            //TODO: update rc.exp
    ...
    if ((inst & 0xF800) == 0x8000)
        {
            ...
            sprintf(core_current.Execute_instr_disp,
                    "Execute: strh r%u,[r%u,#0x%X]", rb_ind, ra_ind,
                    rc.num_value);
