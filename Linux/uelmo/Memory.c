    ...
    if (core_current.Read_valid)        //Performing read
        {
            ...
            switch (core_current.Read_type)
                ...
                case 1:        //byte
                    value =
                        (value >>
                         (8 *
                          (core_current.Memory_addr.num_value & 0x3))) & 0xff;
                ...
                case 2:        //half word
                    value =
                        (value >>
                         (8 *
                          (core_current.Memory_addr.num_value & 0x2))) & 0xffff;
            ...
            sprintf(core_current.Memory_instr_disp,
                    "Memory: load [0x%X]=0x%X",
                    core_current.Memory_addr.num_value, value);
    ...
    if (core_current.Write_valid)       //Performing write
        {
            ...
            sprintf(core_current.Memory_instr_disp,
                    "Memory: store [0x%X]=0x%X",
                    core_current.Memory_addr.num_value,
